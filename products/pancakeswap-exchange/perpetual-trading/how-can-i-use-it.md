...
USDT, BUSD, APX or ADE (with bonus!) can be used as collateral to pay for the trade.
...
As mentioned, using ADE for fees gives you a 5% discount! So, why not?
...
> Note: The trading fees are 0.02% of the notional value for makers and 0.07% for the taker. ADE will be the default payment option for trading fees, followed by APX (ApolloX’s token) and USDT. Any users who are paying the trading fees in ADE will enjoy a 5% discount on trading fees.
