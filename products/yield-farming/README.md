...
Yield Farms allow users to earn ADE while supporting AcentSwap by staking LP Tokens.
...
Why? Because when you stake your LP tokens in a farm to earn ADE, you're still providing liquidity to the liquidity pool, so you earn LP rewards as well!
...
The **Farm Base APR** is calculated according to the farm multiplier and the total amount of liquidity in the farm -- this is the amount of ADE distributed to the farm.
