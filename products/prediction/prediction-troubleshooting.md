...
Enter your wallet address on AcentScan, then check the “Internal Txns” tab to confirm that they’ve arrived.\
...
1. Go to AcentScan page of Prediction contract.
...
1. [Go to the **** AcentScan page of Prediction contract](https://bscscan.com/address/0x18b2a687610328590bc8f2e5fedde3b582a49cda#readContract), and go to the Write tab
...
1. [Go to the **** AcentScan page of Prediction contract](https://bscscan.com/address/0x18b2a687610328590bc8f2e5fedde3b582a49cda#writeContract), and go to the Write tab
