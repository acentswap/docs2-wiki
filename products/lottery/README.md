...
Playing the AcentSwap Lottery gives you a chance to win huge ADE prizes! It's easy, fair, and you can enter as often as you like as long as you have the ADE to buy a ticket.

[View smart contract](https://bscscan.com/address/0x5aF6D33DE2ccEC94efb1bDF8f92Bd58085432d2c)

## **Specifics:**

* Lottery ticket cost for 1 ticket: \~$5 USD in ADE.
...
‌For example, if you have the only ticket that matched three numbers in order, and the predetermined share of the prize pool for your bracket was 2000 ADE, you'll receive the full 2000 ADE.

‌If, however, you and three other people match three numbers in order, the 2000 ADE would be split between the four winning tickets, meaning you would receive 500 ADE.
