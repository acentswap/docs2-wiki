...
**Contract name:** AcentSwapLottery\
...
The AcentSwap Lottery V2 has been audited twice so far. View the results below:
...
[Slowmist's Lottery V2 Audit](https://github.com/slowmist/Knowledge-Base/blob/master/open-report/Smart%20Contract%20Security%20Audit%20Report%20-%20AcentSwap%20Lottery.pdf)
...
| `priceTicketInCake`        | uint256     | The price of a ticket in ADE (approximately $5 USD).                                                                                                                                                                |
...
| `cakePerBracket`           | uint256\[6] | The amount of ADE to distribute to winners of each bracket.                                                                                                                                                         |
...
| `amountCollectedInCake`    | uint256     | The amount of ADE collected through ticket sales for the Lottery round.                                                                                                                                             |
...
| `priceTickets`    | uint256 | The price of a ticket in ADE. |
...
| ----------- | ------- | --------------------------------- |
| `lotteryId` | uint256 | The id of the Lottery.            |
| `amount`    | uint256 | Amount, in ADE token, to inject. |
...
| `priceTicketInCake` | uint256     | Price of a ticket in ADE.                                 |
...
Allows admin to recover incorrect tokens sent to address mistakenly. Cannot be ADE tokens.
...
Allows admin to set upper and lower limit of ticket price in ADE value. Minimum price must be lower than maximum price.

| Name                   | Type    | Description                |
| ---------------------- | ------- | -------------------------- |
| `minPriceTicketInCake` | uint256 | The minimum price in ADE. |
| `maxPriceTicketInCake` | uint256 | The maximum price in ADE. |
