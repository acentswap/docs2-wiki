...
In this tutorial, we're going to guide you through the process of using "cross-chain bridges" to transfer your assets into your BNB Smart Chain wallet, and start using AcentSwap.
...
10. Once finished. You should receive your fund in your BSC wallet. Now you can start using AcentSwap to swap some tokens on BNB Smart Chain!
{% endtab %}
...
10. Once finished. You should receive your funds in your BSC wallet. Now you can start using AcentSwap to swap some tokens on BNB Smart Chain!
